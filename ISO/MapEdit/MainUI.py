...
class Ui_DruIsoMapEdit(object):
    def setupUi(self, DruIsoMapEdit):
        ...
        self.actionClose = QAction(DruIsoMapEdit)
    ...
    def retranslateUi(self, DruIsoMapEdit):
        ...
        self.actionClose.setText(QCoreApplication.translate("DruIsoMapEdit", u"Close", None))
        self.actionExit.setText(QCoreApplication.translate("DruIsoMapEdit", u"Exit", None))
